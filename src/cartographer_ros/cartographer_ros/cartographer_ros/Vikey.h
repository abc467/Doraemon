...
#define VIKEY_ERROR_TIME					0x8000001E //加密狗时钟错误
#define VIKEY_ERROR_TIME_EXPIRE				0x8000001F //加密狗时钟限制已经到期
#define VIKEY_ERROR_TIME_DISORDER			0x80000020 //加密狗时钟失调
