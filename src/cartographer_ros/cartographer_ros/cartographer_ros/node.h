...
namespace cartographer_ros
{
    ...
    public:
        ...
        // for the function above can only be executed when ROS::spin is exited.
        void FinishAllTrajectoriesInROS();
        ...
        bool FinishTrajectoryInROS(int trajectory_id);
    ...
    private:
        ...
        ::ros::Publisher active_trajectory_node_list_publisher_;
