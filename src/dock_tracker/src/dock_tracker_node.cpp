...
public:
        ...
        : pnh_("~")
    {
        ...
        pnh_.param("icp_fitness_thresh", icp_fitness_thresh_, 0.00006);
        ...
        ROS_INFO("Dock Tracker Started. scan=%s dock_pose=%s base_frame=%s",
                 scan_topic_.c_str(), dock_pose_topic_.c_str(), base_frame_.c_str());
    }
