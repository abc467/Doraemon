...
int main(int argc, char** argv) {
  ...
  const std::string usage_message =
      ...
      "\tvalidate-flirt-migration - Validates a FLIRT frame candidate.";
  ...
  } else if (std::string(argv[1]) == "validate-flirt-migration") {
    return ::cartographer::io::pbstream_validate_flirt_migration(argc, argv);
  } else {
