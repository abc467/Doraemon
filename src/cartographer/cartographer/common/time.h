...
namespace cartographer
{
  namespace common
  {
    ...
    // extern volatile bool need_reloc;
    // extern volatile bool reloced;
    // extern volatile bool need_flirt;
    ...
    //   Relocated,
    // };
    // extern int constraints_count;
    // extern RelocateState relocate_state;
