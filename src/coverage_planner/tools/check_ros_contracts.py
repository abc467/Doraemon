...
from cleanrobot_app_msgs.msg import (
    ...
    DockCalibrationState as AppDockCalibrationState,
...
from cleanrobot_app_msgs.srv import (
    ...
    GetDockCalibrationStatus as AppGetDockCalibrationStatus,
    GetDockCalibrationStatusResponse as AppGetDockCalibrationStatusResponse,
    GetManualDriveStatus as AppGetManualDriveStatus,
    GetManualDriveStatusResponse as AppGetManualDriveStatusResponse,
    ...
    ManualDriveCommand as AppManualDriveCommand,
    ManualDriveCommandResponse as AppManualDriveCommandResponse,
    OperateDockCalibration as AppOperateDockCalibration,
    OperateDockCalibrationResponse as AppOperateDockCalibrationResponse,
...
def _local_contracts():
    return {
        ...
        "get_slam_status_app": build_contract_report(
            ...
            features=[
                "structured_slam_state",
                "workflow_state_projection",
                "map_frame_robot_pose",
                "cleanrobot_app_msgs_parallel",
            ],
        ),
        ...
        "manual_drive_command_app": build_contract_report(
            service_name="/clean_robot_server/app/manual_drive_command",
            contract_name="manual_drive_command_app",
            service_cls=AppManualDriveCommand,
            request_cls=AppManualDriveCommand._request_class,
            response_cls=AppManualDriveCommandResponse,
            dependencies={},
            features=[
        ...
        "get_manual_drive_status_app": build_contract_report(
            service_name="/clean_robot_server/app/get_manual_drive_status",
            contract_name="get_manual_drive_status_app",
            service_cls=AppGetManualDriveStatus,
            request_cls=AppGetManualDriveStatus._request_class,
            response_cls=AppGetManualDriveStatusResponse,
            dependencies={},
            features=[
        ...
        "dock_calibration_command_app": build_contract_report(
            service_name="/clean_robot_server/app/dock_calibration_command",
            contract_name="dock_calibration_command_app",
            service_cls=AppOperateDockCalibration,
            request_cls=AppOperateDockCalibration._request_class,
            response_cls=AppOperateDockCalibrationResponse,
            dependencies={"state": AppDockCalibrationState},
            features=[
                "dock_stage1_stage2_calibration",
                "save_current_tracked_pose",
                "dock_tracker_score_display",
                "precise_docking_parameter_set",
                "cleanrobot_app_msgs_parallel",
            ],
        ),
        "get_dock_calibration_status_app": build_contract_report(
            service_name="/clean_robot_server/app/get_dock_calibration_status",
            contract_name="get_dock_calibration_status_app",
            service_cls=AppGetDockCalibrationStatus,
            request_cls=AppGetDockCalibrationStatus._request_class,
            response_cls=AppGetDockCalibrationStatusResponse,
            dependencies={"state": AppDockCalibrationState},
            features=[
                "dock_calibration_status",
                "tracked_pose_snapshot",
                "dock_tracker_score_display",
                "precise_docking_parameter_readback",
                "cleanrobot_app_msgs_parallel",
            ],
        ),
