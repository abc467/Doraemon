...
if [[ "${CHASSIS_DRIVER}" == "mcore_serial" ]]; then
  DEFAULT_CHASSIS_DEVICE="${DORAEMON_MCORE_SERIAL_DEVICE:-/dev/serial/by-path/pci-0000:67:00.4-usb-0:1.3:1.0-port0}"
...
LIDAR_IP="${DORAEMON_LIDAR_IP:-192.168.127.88}"
IMU_DEVICE="${DORAEMON_IMU_DEVICE:-/dev/serial/by-path/pci-0000:65:00.3-usb-0:3:1.0-port0}"
ODOM_DEVICE="${DORAEMON_ODOM_DEVICE:-/dev/serial/by-path/pci-0000:65:00.3-usb-0:1:1.0-port0}"
