...
FRONTEND_BACKEND_MANUAL_DRIVE_REQUIRE_ROLE="${FRONTEND_BACKEND_MANUAL_DRIVE_REQUIRE_ROLE:-false}"
FRONTEND_BACKEND_MANUAL_DRIVE_REQUIRE_SLAM_STATE="${FRONTEND_BACKEND_MANUAL_DRIVE_REQUIRE_SLAM_STATE:-false}"
FRONTEND_BACKEND_MANUAL_DRIVE_REQUIRE_TASK_STATE="${FRONTEND_BACKEND_MANUAL_DRIVE_REQUIRE_TASK_STATE:-false}"
FRONTEND_BACKEND_MANUAL_DRIVE_REQUIRE_ODOMETRY_STATE="${FRONTEND_BACKEND_MANUAL_DRIVE_REQUIRE_ODOMETRY_STATE:-false}"
FRONTEND_BACKEND_MANUAL_DRIVE_REQUIRE_COMBINED_STATUS="${FRONTEND_BACKEND_MANUAL_DRIVE_REQUIRE_COMBINED_STATUS:-false}"
FRONTEND_BACKEND_MANUAL_DRIVE_PUBLISH_HZ="${FRONTEND_BACKEND_MANUAL_DRIVE_PUBLISH_HZ:-20.0}"
